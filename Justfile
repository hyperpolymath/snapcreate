...
doctor:
    @echo "Running diagnostics for snapcreate..."
...
help-me:
    @echo "=== snapcreate Help ==="
    @echo "Platform: $(uname -s) $(uname -m)"
    @echo "Shell: $SHELL"
    @echo ""
    @echo "To report an issue:"
    @echo "  https://github.com/hyperpolymath/snapcreate/issues/new"
    @echo ""
