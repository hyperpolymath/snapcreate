...
// Replace snapcreate, Snapcreate — See README.adoc for details., just run, Snapcreate started successfully. with actuals
= snapcreate — Quick Start for Users
:toc:
:toclevels: 2

== What is snapcreate?

Snapcreate — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./snapcreate-portable
----
...
[source]
----
Snapcreate started successfully.
----
...
* **Wiki**: https://github.com/hyperpolymath/snapcreate/wiki
