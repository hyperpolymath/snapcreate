...
| License (MIT / PMPL-1.0-or-later) | Done | Dual license with Palimpsest overlay
...
Contributions will be welcome once the project specification is in place. See link:.github/CONTRIBUTING.md[CONTRIBUTING.md] for the general process.
