...
[arabic]
. Navigate to
https://github.com/hyperpolymath/snapcreate/security/advisories/new[Report
a Vulnerability]
...
https://github.com/hyperpolymath/snapcreate/security/advisories[Security
Advisories]
...
|*General questions*
|https://github.com/hyperpolymath/snapcreate/discussions[GitHub
Discussions]
...
_Thank you for helping keep Snapcreate and its users safe._ 🛡️
